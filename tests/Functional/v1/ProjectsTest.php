...
class ProjectsTest extends RestTestCase
{
    ...
    protected function getData()
    {
        ...
        return [
            ...
            'clnt_cvs_dir'       => $this->faker()->realText(32),
            'pnp_type'           => $this->faker()->realText(32),
            'clnt_code'          => $this->faker()->realText(16),
            'clnt_code2'         => $this->faker()->realText(16),
            'src_prefix'         => substr($this->faker()->realText(10), 0, 8),
            'src_prefix2'        => null,
            'src_itf_prefix'     => null,
            'getdcli'            => $this->faker()->realText(16),
            'getdcli2'           => $this->faker()->realText(16),
            'activity'           => null,
            'activite_gpc'       => null,
            'activite_sdr'       => "o",
            'imx_formstag'       => null,
            ...
            'uses_transl_upd'    => 0,
            'inactive'           => 0,
            'display_name'       => $this->faker()->realText(128),
